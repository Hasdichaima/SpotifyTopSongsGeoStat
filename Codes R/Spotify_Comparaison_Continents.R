...
"Date : Décembre 2023"
"Objectif : Réaliser la comparaison des données Spotify par continent" 
...
music_spotify <-  read.csv("Final_Data/spotify_ISO_IDH.csv") #a modifier
...
continentMonde <- read.csv('data/continents.csv', sep=';') #a modifier

...
"Date : Decembre 2023"
"Objectif : Réaliser toutes les analyses des données FMA dont la méthode ACP"
...
#Médiane des caractéristiques musicales selon le continent

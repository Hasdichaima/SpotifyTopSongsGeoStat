"Auteur : Chaima HASDI"
"Date : Décembre 2023"
"Objectif : Réaliser les cartes et les regressions linéaires" 
"de la 'danceability' et 'popularity' en fonction de l'IDH"

"ATTENTION: Pour que le code fonctionne, remplacer 'à modifier' par le bon chemin du fichier"

setwd("C:/Users/user/Documents/GitHub/SpotifyTopSongsGeoStat") #à modifier

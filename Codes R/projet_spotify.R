...
"Date : Décembre 2023"
"Objectif : Réaliser les jointures nécessaires pour le fichier spotify." 
"Fichier final : 'spotify_ISO_IDH.csv'" 
...
echonest <- read.csv('echonest.csv', sep=';') #a modifier
...
#Le jeu de données qui nous intéresse est "spotify_ISO_IDH.csv" puisqu'il contient les informations de la table intiale spotify avec l'idh de chaque pays et son code ISO associé